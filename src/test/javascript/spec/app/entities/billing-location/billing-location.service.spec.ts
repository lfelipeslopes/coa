...
describe('Service Tests', () => {
    describe('BillingLocation Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new BillingLocation(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a BillingLocation', async () => {
                ...
                service
                    .create(new BillingLocation(null))
                    .pipe(take(1))
            ...
            it('should update a BillingLocation', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        code: 'BBBBBB'
            ...
            it('should return a list of BillingLocation', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        code: 'BBBBBB'
            ...
            it('should delete a BillingLocation', async () => {
