...
import { IOperator, Operator, OperatorStatus } from 'app/shared/model/operator.model';
...
describe('Service Tests', () => {
    describe('Operator Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Operator(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', OperatorStatus.ATICVE);
        });
