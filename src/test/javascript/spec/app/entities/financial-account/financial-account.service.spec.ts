...
describe('Service Tests', () => {
    describe('FinancialAccount Service', () => {
        ...
        let elemDefault: IFinancialAccount;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a FinancialAccount', async () => {
                ...
                service
                    .create(new FinancialAccount(null))
                    .pipe(take(1))
            ...
            it('should update a FinancialAccount', async () => {
                const returnedFromService = Object.assign(
                    {
                        alias: 'BBBBBB',
                        balance: 1,
            ...
            it('should return a list of FinancialAccount', async () => {
                const returnedFromService = Object.assign(
                    {
                        alias: 'BBBBBB',
                        balance: 1,
            ...
            it('should delete a FinancialAccount', async () => {
