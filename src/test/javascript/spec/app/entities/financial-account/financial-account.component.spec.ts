...
import { FinancialAccountComponent } from 'app/entities/financial-account/financial-account.component';
...
describe('Component Tests', () => {
    describe('FinancialAccount Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.financialAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
