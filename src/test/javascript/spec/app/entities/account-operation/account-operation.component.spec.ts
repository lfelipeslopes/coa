...
import { AccountOperationComponent } from 'app/entities/account-operation/account-operation.component';
...
describe('Component Tests', () => {
    describe('AccountOperation Management Component', () => {
        let comp: AccountOperationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AccountOperationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.accountOperations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
