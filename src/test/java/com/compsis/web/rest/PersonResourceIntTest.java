...
import com.compsis.domain.Person;
import com.compsis.repository.PersonRepository;
import com.compsis.service.PersonService;
import com.compsis.service.dto.PersonDTO;
import com.compsis.service.mapper.PersonMapper;
...
public class PersonResourceIntTest {
    ...
    private static final TypePerson DEFAULT_TYPE_PERSON = TypePerson.PRE_PAID;
    private static final TypePerson UPDATED_TYPE_PERSON = TypePerson.ASSOCIATED;
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person()
            ...
            .name(DEFAULT_NAME)
            .email(DEFAULT_EMAIL)
            .typePerson(DEFAULT_TYPE_PERSON);
        return person;
    }
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getDocument()).isEqualTo(DEFAULT_DOCUMENT);
        assertThat(testPerson.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testPerson.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testPerson.getTypePerson()).isEqualTo(DEFAULT_TYPE_PERSON);
    }
    ...
    public void getAllPeople() throws Exception {
        ...
        restPersonMockMvc.perform(get("/api/people?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].typePerson").value(hasItem(DEFAULT_TYPE_PERSON.toString())));
    }
    ...
    public void getPerson() throws Exception {
        ...
        restPersonMockMvc.perform(get("/api/people/{id}", person.getId()))
            ...
            .andExpect(jsonPath("$.typePerson").value(DEFAULT_TYPE_PERSON.toString()));
    }
    ...
    public void updatePerson() throws Exception {
        ...
        updatedPerson
            ...
            .name(UPDATED_NAME)
            .email(UPDATED_EMAIL)
            .typePerson(UPDATED_TYPE_PERSON);
        ...
        Person testPerson = personList.get(personList.size() - 1);
        assertThat(testPerson.getDocument()).isEqualTo(UPDATED_DOCUMENT);
        assertThat(testPerson.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testPerson.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testPerson.getTypePerson()).isEqualTo(UPDATED_TYPE_PERSON);
    }
